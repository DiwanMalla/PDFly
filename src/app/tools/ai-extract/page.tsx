    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="container mx-auto px-4 py-20">
        ...
        >
          ...
          >
            Intelligent data extraction from documents using advanced AI.
            Extract structured data, tables, forms, and key information with
          ...
          >
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-100 shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Extract form fields and structured data automatically
              </p>
            </div>
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-100 shadow-lg">
              <div className="text-4xl mb-4">📊</div>
              ...
              <p className="text-gray-600 text-sm">
                Convert tables and charts to structured formats
              </p>
            </div>
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-100 shadow-lg">
              <div className="text-4xl mb-4">🎯</div>
              ...
              <p className="text-gray-600 text-sm">
                Identify and extract important data points
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-blue-200 shadow-xl max-w-md mx-auto mb-8"
          >
            ...
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-blue-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-800"
              />
