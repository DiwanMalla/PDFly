        ...
        {activeTab === "suggestions" && (
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-800">Suggestions & Bug Reports</h2>
              ...
              <div className="space-y-4">
                {suggestions.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">Suggestions and bug reports will appear here.</p>
                  </div>
                ) : (
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Update your admin password</div>
                      </div>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-800 mb-4">System Info</h3>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <span className="text-gray-600">Admin Email:</span>
                        <span className="ml-2 font-medium">{sessionStorage.getItem('adminEmail')}</span>
                      </div>
                      <div>
