...
const TEMP_HASH = "$2b$10$wTm2nUt4ijndFzH0aPutgujzDyeX2xO7N7AeAQWURu7n996nobEiu";
...
async function getAdmin(): Promise<Admin | null> {
  return await prisma.admin.findUnique({ where: { email: "malladipin@gmail.com" } });
}
    ...
    <div className="max-w-3xl mx-auto py-10">
      {needsPasswordChange && (
        <Suspense fallback={null}>
          <ChangePasswordDialog email={admin.email} onSuccess={() => window.location.reload()} />
        </Suspense>
      )}
