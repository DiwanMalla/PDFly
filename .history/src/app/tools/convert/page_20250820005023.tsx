...
const ConvertPage: React.FC = () => {
  ...
  const formatOptions = [
    { id: 'word', name: 'Word Document', desc: 'Convert to DOCX format', icon: '📄' },
    { id: 'excel', name: 'Excel Spreadsheet', desc: 'Convert to XLSX format', icon: '📊' },
    { id: 'powerpoint', name: 'PowerPoint', desc: 'Convert to PPTX format', icon: '📈' },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            {isProcessing && (
              <div className="bg-white rounded-2xl shadow-sm border p-6">
                ...
                <p className="text-center text-sm text-gray-500 mt-1">
                  Converting to {formatOptions.find(f => f.id === convertTo)?.name}...
                </p>
              </div>
            )}
            ...
            {convertedResult && (
              <div className="bg-white rounded-2xl shadow-sm border p-6">
                <h3 className="text-lg font-semibold mb-4">✅ Conversion Complete!</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span>Format:</span>
                    <span className="font-medium">{convertedResult.format}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>File size:</span>
