            ...
            <div className="xl:col-span-1 space-y-6">
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center space-x-3 p-3 border rounded-xl hover:bg-gray-50 cursor-pointer">
                      <input
                        ...
                        onChange={() =>
                          setSplitOptions(prev => ({ ...prev, mode: "pages" }))
                        }
                        className="text-orange-600"
                      />
                      <div>
                        <div className="font-medium">Extract Selected Pages</div>
                    ...
                    <label className="flex items-center space-x-3 p-3 border rounded-xl hover:bg-gray-50 cursor-pointer">
                      <input
                        ...
                        onChange={() =>
                          setSplitOptions(prev => ({ ...prev, mode: "ranges" }))
                        }
                        className="text-orange-600"
                      />
                      <div>
                    ...
                    <label className="flex items-center space-x-3 p-3 border rounded-xl hover:bg-gray-50 cursor-pointer">
                      <input
                        ...
                        onChange={() =>
                          setSplitOptions(prev => ({ ...prev, mode: "every" }))
                        }
                        className="text-orange-600"
                      />
                      <div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          onClick={() =>
                            setSplitOptions(prev => ({
                              ...prev,
                              everyNPages: Math.min(pdfPages.length, prev.everyNPages + 1),
                            }))
                          }
                          className="p-2 border rounded-lg hover:bg-gray-100"
                        >
                  ...
                  {(splitOptions.mode === "pages" || splitOptions.mode === "extract") && (
                  ...
                  {!splitProgress.isProcessing && splitResults.length === 0 && (
                    <button
                      onClick={handleSplit}
                      disabled={
                        (splitOptions.mode === "pages" && pdfPages.filter(p => p.selected).length === 0) ||
                        (splitOptions.mode === "ranges" && !splitOptions.ranges.trim())
                      }
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{splitProgress.currentStep}</span>
                      <span className="font-semibold">{splitProgress.progress}%</span>
                    </div>
            ...
            <div className="xl:col-span-2">
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-sm text-gray-600">
                    {pdfPages.filter(p => p.selected).length} of {pdfPages.length} selected
                  </div>
                </div>
