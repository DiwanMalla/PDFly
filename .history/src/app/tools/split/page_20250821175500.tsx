...
const SplitPage: React.FC = () => {
  ...
  const loadPDFPages = async (file: File) => {
    try {
      // Load PDF.js dynamically with proper Next.js handling
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xl text-white/90">
                    Extract, separate, and organize your PDF pages with precision
                  </p>
                </div>
              </div>
            </div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    Select a PDF file to split into separate documents. We support files up to 100MB.
                  </p>
                  <button
                          ...
                          <input
                            ...
                            onChange={() =>
                              setSplitOptions((prev) => ({
                                ...prev,
                                mode: option.mode as "pages" | "ranges" | "extract" | "every",
                              }))
                            }
                  ...
                  <div className="p-6">
                    {pdfPages.length > 0 ? (
                      ...
                      <div className="text-center py-16">
                        ...
                        <p className="text-gray-500 text-lg">Loading PDF pages...</p>
