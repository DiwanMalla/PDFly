"use client";
                        <button
                          onClick={async (e) => {
                            e.preventDefault();
                            const selectedFile = new File([result.blob], result.name, {
                        ...
                        <button
                          onClick={async (e) => {
                            ...
                            reader.onload = () => {
                              const base64Data = reader.result as string;
                              sessionStorage.setItem("initialFileBlob", base64Data);
                              window.location.href = `/tools/convert`;
                            };
                            reader.readAsDataURL(selectedFile);
                          }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {splitResults.map((result, index) => (
                    ...
                    >
                      ...
                      {/* Continue Processing Buttons for this result */}
                      <div className="flex space-x-2">
                        <button
                          onClick={async (e) => {
                            ...
                            reader.onload = function (ev) {
                              ...
                              sessionStorage.setItem(
                                "continueProcessConfig",
                                JSON.stringify(processConfig)
                              );
                              console.log(
                                "[DEBUG] continueProcessConfig set:",
                                processConfig
                              );
                          ...
                          className="flex-1 bg-indigo-100 text-indigo-600 px-3 py-2 rounded-lg hover:bg-indigo-200 transition-colors text-xs font-semibold"
                        ...
                        <button
                          ...
                          className="flex-1 bg-pink-100 text-pink-600 px-3 py-2 rounded-lg hover:bg-pink-200 transition-colors text-xs font-semibold"
                        ...
                        <button
                          ...
                          className="flex-1 bg-orange-100 text-orange-600 px-3 py-2 rounded-lg hover:bg-orange-200 transition-colors text-xs font-semibold"
