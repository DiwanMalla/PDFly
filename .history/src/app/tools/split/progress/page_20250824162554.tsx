              ...
              <div className="p-6">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    <button
                      onClick={() => {
                        // Store all split results in sessionStorage as base64
                        const filesToStore = splitResults.map((result) => ({
                          name: result.name,
                          pages: result.pages,
                          size: result.size,
                        }));
                    ...
                    <button
                      onClick={() => {
                        // Store first split result for compress
                    ...
                    <button
                      onClick={() => {
                        // Store first split result for convert
                        if (splitResults.length > 0) {
                          const result = splitResults[0];
                          sessionStorage.setItem(
                            "initialFile",
