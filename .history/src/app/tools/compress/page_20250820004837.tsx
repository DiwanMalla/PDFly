...
const CompressPage: React.FC = () => {
  ...
  const handleCompress = async () => {
    ...
    setTimeout(() => {
      const savings = compressionLevel === 'high' ? '75%' : compressionLevel === 'medium' ? '50%' : '25%';
      const newSize = compressionLevel === 'high' ? '0.8 MB' : compressionLevel === 'medium' ? '1.2 MB' : '1.8 MB';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Best quality, larger file</div>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Balanced quality and size</div>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Smallest file, good quality</div>
                      </div>
                    </label>
                  </div>
                </div>
            ...
            {compressedResult && (
              <div className="bg-white rounded-2xl shadow-sm border p-6">
                <h3 className="text-lg font-semibold mb-4">✅ Compression Complete!</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-green-600">{compressedResult.size}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Space saved:</span>
                    <span className="font-bold text-green-600">{compressedResult.savings}</span>
                  </div>
                </div>
