...
const MergePage: React.FC = () => {
  ...
  // Simulate getting initial file from home page
  useEffect(() => {
    // TODO: Get the initial file from navigation state or query params
    // For now, simulate having one file
    const simulateInitialFile = () => {
      // This would come from the home page navigation
    };
  }, []);
