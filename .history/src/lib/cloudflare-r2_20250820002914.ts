...
const R2_CONFIG = {
  ...
  endpoint: process.env.CLOUDFLARE_R2_ENDPOINT || 'https://ea9ab527d039f10a64b07aaadf30cded.r2.cloudflarestorage.com',
  credentials: {
    accessKeyId: process.env.CLOUDFLARE_R2_ACCESS_KEY_ID || 'b7cc1177192e7fbff3defd0fc2006fac',
    secretAccessKey: process.env.CLOUDFLARE_R2_SECRET_ACCESS_KEY || '26554cf0b6933249fc129989bbb33db95339a3574ab84f09494061289f8183fe',
  },
};
