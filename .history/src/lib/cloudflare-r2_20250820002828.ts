...
const R2_CONFIG = {
  ...
  endpoint: 'https://ea9ab527d039f10a64b07aaadf30cded.r2.cloudflarestorage.com',
  credentials: {
    accessKeyId: 'b7cc1177192e7fbff3defd0fc2006fac',
    secretAccessKey: '26554cf0b6933249fc129989bbb33db95339a3574ab84f09494061289f8183fe',
  },
};

const BUCKET_NAME = 'pdfly-storage'; // You'll need to create this bucket in Cloudflare
