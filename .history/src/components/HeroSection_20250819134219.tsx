        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">AI-Powered PDF Processing</span>
            </motion.div>
            ...
            >
              Experience the future of document processing. Merge, split, compress, edit, and collaborate on PDFs with enterprise-grade security and real-time AI assistance.
            </motion.p>
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 relative z-10">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-900">PDF Processor</h3>
                  ...
                  <div className="border-2 border-dashed border-gray-200 rounded-2xl p-8 text-center bg-gray-50">
                    ...
                    <p className="text-sm text-gray-600">Drop your PDF here or click to browse</p>
                  </div>

                  {/* Processing Options */}
                  <div className="grid grid-cols-2 gap-3">
                    {['Merge', 'Split', 'Compress', 'Convert'].map((action, index) => (
                      <button
                        key={action}
