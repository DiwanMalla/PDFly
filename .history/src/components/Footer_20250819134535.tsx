      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 text-sm leading-relaxed">
              Transform your PDF workflow with AI-powered tools. Trusted by millions of users worldwide for secure, fast, and reliable document processing.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            <div>
              <h3 className="font-semibold text-white mb-2">Get PDFly on all your devices</h3>
              <p className="text-gray-400 text-sm">Work seamlessly across desktop, mobile, and web.</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-400">Available in 25+ languages</span>
