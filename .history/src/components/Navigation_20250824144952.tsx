            ...
            {showFeedback && (
              ...
              >
                <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full border border-gray-200 relative">
                  ...
                  <h2 className="text-xl font-bold mb-2 text-orange-700">Suggest a Feature / Report a Bug</h2>
                  <p className="text-sm text-gray-600 mb-4">Help us improve PDFly! Share your suggestions or report any issues below.</p>
                  <form
                    action="https://formspree.io/f/xwkzqgqg" // Replace with your form endpoint
                    method="POST"
                    target="_blank"
                  >
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full p-3 border border-orange-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm mb-3"
